...
/** Help module: tutorials and setup guides. */
public class HelpActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setupRow(
        ...
        "Watch the tutorial",
        "Learn how to control your phone with facial gestures",
    ...
    setupRow(
        ...
        "Phone stand setup",
        "Place your phone so your face is fully visible",
        v -> startActivity(new Intent(this, TutorialPhoneStandActivity.class)));
  }
